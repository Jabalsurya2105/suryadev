...
export declare const makeRegistrationSocket: (config: SocketConfig) => {
    ...
    getNewsletterInfo: (url: string) => Promise<string>;
    createNewsletter: (name: string, description: string | null) => Promise<string>;
    joinNewsletter: (id: string) => Promise<string>;
    leaveNewsletter: (id: string) => Promise<string>;
    sendNewsletterReaction: (jid: string, serverID: string, reaction: string | null) => Promise<import("../WABinary").BinaryNode>;
    type: "md";
    ws: any;
