...
const makeChatsSocket = (config) => {
    ...
    const _query = async (jid, type, content) => (query({
        tag: 'iq',
        attrs: {
    ...
    */
    ...
    const getNewsletterInfo = async (url) => {
        ...
        const data = await _query('@s.whatsapp.net', 'get', [
            {
                tag: 'query',
                attrs: {
        ...
        let result = JSON.parse((0, WABinary_1.getBinaryNodeChildString)(data, 'result') || '{}');
        return JSON.stringify(result, null, 2);
    };
    const createNewsletter = async (name, description) => {
        const payload = {
            variables: {
                newsletter_input: {
                    name,
        ...
        const result = JSON.parse((0, WABinary_1.getBinaryNodeChildString)(data, 'result') || '{}');
        return JSON.stringify(result, null, 2);
    };
    const joinNewsletter = async (id) => {
        const payload = {
            variables: {
                newsletter_id: id,
            },
    ...
    const leaveNewsletter = async (id) => {
        const payload = {
            variables: {
                newsletter_id: id,
            },
    ...
    const sendNewsletterReaction = async (jid, serverID, reaction) => {
        const payload = {
            tag: 'message',
            attrs: {
                to: jid,
