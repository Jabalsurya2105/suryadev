            ...
            if (Array.isArray(stanza.content)) {
                for (const { tag, attrs, content } of stanza.content) {
                    ...
                    try {
                        ...
                        if (msgBuffer) {
                            msg = WAProto_1.proto.Message.decode(tag === 'plaintext' ? msgBuffer : (0, generics_1.unpadRandomMax16)(msgBuffer));
                            msg = ((_a = msg === null || msg === void 0 ? void 0 : msg.deviceSentMessage) === null || _a === void 0 ? void 0 : _a.message) || msg;
                        }
                        else {
                            msg = (attrs === null || attrs === void 0 ? void 0 : attrs.code) ? WAProto_1.proto.Message.create({ reactionMessage: { text: attrs.code } }) : {};
                        }
                        if (msg === null || msg === void 0 ? void 0 : msg.senderKeyDistributionMessage) {
                            try {
